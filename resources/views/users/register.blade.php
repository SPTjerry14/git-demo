...
<body>
    <div id="wrapper">
        <form action="" id="form-login" method="POST">
            @csrf <!-- {{ csrf_field() }} -->
            <h1 class="form-heading">Form đăng ky</h1>
			...
			<div class="form-group">
                <i class="far fa-user"></i>
                <input type="text" class="form-input" placeholder="phone" name="phone">
            </div>
            <div class="form-group">
			...
			<div class="form-group">
                <i class="fas fa-key"></i>
                <input type="password" class="form-input" placeholder="Xac Nhan Mật khẩu" name="password_confirmation">
                <div id="eye">
                    <i class="far fa-eye"></i>
                </div>
            </div>
